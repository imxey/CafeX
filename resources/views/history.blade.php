<x-app-layout>
    ...
    {{-- MODAL MABAC GLOBAL --}}
    <div x-data="mabacModalData()"
        @open-mabac-modal.window="openModal($event.detail)"
            ...
            <div class="space-y-2">
                <template x-for="(section, index) in sections" :key="index">
                    <div class="border border-gray-300 rounded overflow-hidden">
                        ...
                        <div x-show="openItem === index" x-collapse class="px-4 py-3 text-sm text-gray-700 bg-white">
                            {{-- Logika tabel atau teks (sama seperti sebelumnya) --}}
...
<script>
    function mabacModalData() {
        return {
            ...
            sections: [],
            openModal(detail) {
                this.modalTitle = `${detail.recommendationDateTime} – ${detail.title}`; // title di sini adalah nama cafe
                this.sections = [{
                        title: `Normalized Matrix (Baris untuk ${detail.title})`,
                        content: detail.normalizedData || [],
                        type: 'array'
                    },
                    {
                        title: `Weighted Matrix (Baris untuk ${detail.title})`,
                    ...
                    {
                        title: `Distance to Border Approximation Matrix (Baris untuk ${detail.title})`,
                ...
                this.isOpen = true;
                this.openItem = null; // Reset accordion di dalam modal
            }
        }
    }
</script>
